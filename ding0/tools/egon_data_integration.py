...
def get_res_generators(orm, session, mv_grid_district):
    ...
    query = (
        ...
        .filter(
            ...
            orm["generators_pv"].capacity <= 13.5,  # (according to SNB)
            func.ST_Intersects(
    ...
    query = (
        ...
        .filter(
            ...
            orm["generators_wind"].capacity <= 13.5,  # (according to SNB)
            func.ST_Intersects(
                func.ST_GeomFromText(geo_area.wkt, get_config_osm("srid")),
    ...
    query = session.query(
        ...
        orm["generators_biomass"].capacity <= 13.5,  # (according to SNB)
        func.ST_Intersects(
            func.ST_GeomFromText(geo_area.wkt, get_config_osm("srid")),
    ...
    query = session.query(
        ...
        orm["generators_water"].capacity <= 13.5,  # (according to SNB)
        func.ST_Intersects(
            func.ST_GeomFromText(geo_area.wkt, get_config_osm("srid")),
...
def get_conv_generators(orm, session, mv_grid_district):
    ...
    query = session.query(
        ...
        orm["generators_combustion"].capacity <= 13.5,  # (according to SNB)
        func.ST_Intersects(
            func.ST_GeomFromText(geo_area.wkt, get_config_osm("srid")),
            func.ST_Transform(orm["generators_combustion"].geom, srid),
        ),
    ...
    query = session.query(
        ...
        orm["generators_gsgk"].capacity <= 13.5,  # (according to SNB)
        func.ST_Intersects(
            func.ST_GeomFromText(geo_area.wkt, get_config_osm("srid")),

...
def connection(section='oedb'):
    """DINGO-specific database connection method which uses oemof.db
    
    This function checks if DINGO's config file for access to databases
    ...
    db_config_file = str(cfg_dingo.get('config',
                                       'db_config_file'))
